...
- SAS users learning Databricks
- Beginners learning PySpark ML
- Students who need visual examples with clean Python code
- Teams preparing SAS-to-Databricks migration training material

## How To Use

1. Open the notebooks in Databricks or a Spark-enabled notebook environment.
2. Run the cells from top to bottom.
3. Start with notebook `01`, then move through `02`, `03`, and `04`.

## Notes

- Spark examples expect a Databricks/PySpark runtime where `spark` is already available.
- Notebook outputs are cleared so the files stay clean for Git.
- Code is intentionally simple and lightly written for beginner readability.
